           ...
           tabPanel("More resources",
                    ...
                    mainPanel(      HTML(paste( "<b>Developers</b>",
                                       ...
                                       the Stata module <a href='https://ideas.repec.org/c/boc/bocode/s458592.html'>EVALUE</a>.",
                                                ...
                                                "<br><br><a href='https://biostats.bepress.com/harvardbiostat/paper215/'>(2) VanderWeele TJ, Ding P, Mathur MB. (2019). Technical considerations in the use of the E-value.",
